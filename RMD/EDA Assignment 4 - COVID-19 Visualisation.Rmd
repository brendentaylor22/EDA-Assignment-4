...
df_ncov$iso3c = countrycode(sourcevar = ncov$Country, origin = "country.name", destination = "wb")
...
df_geom$iso3c = countrycode(sourcevar = world_ne$sovereignt, 
...
df_with_countrycodes = add_countrycodes()
